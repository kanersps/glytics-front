        ...
        return (
            <BrowserRouter style={{height: "100%"}}>
                <Layout className="layout"
                        style={{minHeight: "100vh", background: this.state.darkmode ? "#222222" : null}}>

                    <Header accountName={this.state.accountName} darkmode={this.state.darkmode}
                            toggleDarkMode={() => {
                                this.toggleDarkMode()
                            }} logout={() => {
                        this.logout();
                    }} updateDashboard={(a, b) => {
                        this.updateDashboard(a, b)
                        ...
                        <div style={{marginTop: 20}}>
                            <Switch>
                                <Route path={["/account", "/applications"]}>
                                    ...
                                    }} darkmode={this.state.darkmode} logout={this.logout}
                                             updateDashboardTo={this.state.updateDashboardTo}
                                             updateDashboardToCategory={this.state.updateDashboardToCategory}
                                             shouldUpdateDashboard={this.state.updateDashboard}
                                             setApiKey={this.setApiKey} setLoggedIn={this.loggedIn}
                                             loggedIn={this.state.loggedIn} apikey={localStorage.getItem("apikey")}/>
                                </Route>
                                ...
                                <Route path="/">
                                    <Content style={{padding: '0 50px'}}>
                                        ...
                                        <Footer style={{
                                            backgroundColor: this.state.darkmode ? "#222222" : null,
