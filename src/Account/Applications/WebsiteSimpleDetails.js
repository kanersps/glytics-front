        ...
        if (!this.state.loading) {
            content = <Row style={{
                ...
                <Col span={24}>
                    ...
                    <span>&nbsp;&nbsp;&nbsp;&nbsp;<a href={this.state.address} rel={"noreferrer"}
                                                     target={"_blank"}>{this.state.address}</a> </span>
                ...
                <Col span={24}>
                    <Row>
                        <Col>
                            <Title style={{color: this.props.darkmode ? "white" : "black"}} level={3}>Overview</Title>
                        </Col>
                        <Col flex={"auto"} style={{textAlign: "right"}}>
                            <Link to={"/applications/website/" + this.props.code}><Button type={"primary"}
                                                                                          style={{marginRight: 10}}>More
                                Details</Button></Link>
                            <Button onClick={() => {
                                this.reloadOverview()
                            }} loading={this.state.reloading} icon={<ReloadOutlined/>}>Reload</Button>
                        </Col>
                    </Row>
                ...
                <Col span={24}>
                    <Row>
                        <Col span={20}>
                            <Title style={{color: this.props.darkmode ? "white" : "black"}} level={3}>Tracking
                                Code</Title>
                        </Col>
